...
### acl2018
python3 map_embeddings.py --acl2018 --verbose data/embeddings/original/ELMo/en.txt data/embeddings/original/ELMo/fr.txt data/embeddings/mapped/ELMo/en-fr/en.txt data/embeddings/mapped/ELMo/fen-fr/r.txt
### acl2018 NGC
